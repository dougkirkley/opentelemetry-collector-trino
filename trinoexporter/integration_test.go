...
func TestIntegration(t *testing.T) {
	testCase := []struct {
		...
		// {
		//	name:  "test trino 24-alpine",
		//	image: "trino/trino-server:24-alpine",
		// },
		// {
		//	name:  "test trino 23-alpine",
		//	image: "trino/trino-server:23-alpine",
		// },
		// {
		//	name:  "test trino 22-alpine",
		//	image: "trino/trino-server:22-alpine",
		// },
	}
...
func verifyExportLog(t *testing.T, logExporter *logsExporter) {
	...
	expectLog := log{
		...
		ScopeName:      "io.opentelemetry.contrib.trino",
		ScopeVersion:   "1.0.0",
